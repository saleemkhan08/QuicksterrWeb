...
class CurrentItemVariantDialog extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      comment: "",
...
CurrentItemVariantDialog.propTypes = {
  open: PropTypes.bool,
...
export default connect(mapStateToProps)(CurrentItemVariantDialog);
